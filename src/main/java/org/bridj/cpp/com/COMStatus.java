...
public class COMStatus extends RuntimeException {
	...
	private static final Map<Integer, String> DESCRIPTIONS = new ConcurrentHashMap<Integer, String>();
	...
	public static boolean check(int hResult, String message, Object... args) {
		...
		if (DESCRIPTIONS.isEmpty()) {
			try {
				...
				InputStream inStream = COMStatus.class.getResourceAsStream(COMStatus.class.getSimpleName() + ".properties");
				msg.load(inStream);
				inStream.close();
				...
				DESCRIPTIONS.put(S_OK, "OK");
			}
		}

		String description = DESCRIPTIONS.get(hResult);
		if (description == null) {
			throw new COMStatus(hResult, "Unknown<" + Integer.toHexString(hResult) + ">", message, args);
		}
		throw new COMStatus(hResult, description, message, args);
	}

	private final int hResult;

	private COMStatus(int hResult, String description, String message, Object... args) {
		super(message == null ? description : (description + " - " + String.format(message, args)));
